 ...
 */
final class Version20210402011116 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE reservation_maison (id INT AUTO_INCREMENT NOT NULL, chambre_id INT NOT NULL, user_id INT NOT NULL, date_reservation DATE NOT NULL, etats VARCHAR(255) NOT NULL, INDEX IDX_B1FDFFF69B177F54 (chambre_id), INDEX IDX_B1FDFFF6A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
