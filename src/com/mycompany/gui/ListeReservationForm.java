 ...
 * @author yassin
 */
public class ListeReservationForm extends BaseForm {

    Form current;

    public ListeReservationForm(Resources res) {
        ...
        ArrayList<ReservationRandonne> list = ServiceReservationRandonne.getInstance().getAllreservationrandonne();
        for (ReservationRandonne rec : list) {
    ...
    private void addButton(Image img, ReservationRandonne rec, Resources res) {
        ...
        Label NumeroTxt = new Label("N° :" + rec.getNumreservation(), "NewsTopLine2");
        Label DateTxt = new Label("Date :" + rec.getDatereservation(), "NewsTopLine2");
        Label ObservationTxt = new Label("Observation :" + rec.getObservation(), "NewsTopLine2");
        Label MontantTxt = new Label("Montant :" + rec.getMontant(), "NewsTopLine2");
        Label Nombre = new Label("Nombre :" + rec.getNombrepersonne(), "NewsTopLine2");
        ...
        lSupprimer.addPointerPressedListener(l -> {
            ...
            if (dig.show("Suppression", "Vous voulez supprimer cette reclamation ?", "Annuler", "Oui")) {
                ...
                if (ServiceReservationRandonne.getInstance().deleteReseration(rec.getIdr())) {
                    new ListeReservationForm(res).show();
                }
            }
        });
        ...
        lModifier.addPointerPressedListener(l -> {
            ...
            new ModifierReservationForm(res, rec).show();
        });

        cnt.add(BorderLayout.CENTER, BoxLayout.encloseY(
                BoxLayout.encloseX(NumeroTxt),
                BoxLayout.encloseX(DateTxt),
                BoxLayout.encloseX(ObservationTxt),
                BoxLayout.encloseX(MontantTxt),
                BoxLayout.encloseX(Nombre),
