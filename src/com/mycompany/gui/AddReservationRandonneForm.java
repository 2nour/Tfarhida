 ...
 * @author yassin
 */
public class AddReservationRandonneForm extends BaseForm {

    Form current;

    public AddReservationRandonneForm(Resources res) {
        ...
        /////////////////////////////////////////////////
        TextField tfNumreservation = new TextField("", "numreservation");
        tfNumreservation.setUIID("textFieldBack");
        addStringValue("tfNumreservation", tfNumreservation);

//        TextField tfDatereservation = new TextField("", "datereservation");
//        tfDatereservation.setUIID("textFieldBack");
//        addStringValue("tfDatereservation", tfDatereservation);
        Picker Date = new Picker();
        Date.setUIID("textFieldBack");
        addStringValue("Datereservation", Date);

        TextField tfObservation = new TextField("", "observation");
        tfObservation.setUIID("textFieldBack");
        addStringValue("tfObservation", tfObservation);

        TextField tfMontant = new TextField("", "montant");
        tfMontant.setUIID("textFieldBack");
        addStringValue("tfMontant", tfMontant);

        TextField tfNombrepersonne = new TextField("", "nombrepersonne");
       ...
       // addStringValue("tfEtat", tfEtat);
        ...
        btnAjouterRec.addActionListener((e) -> {
            ...
            if (tfNumreservation.getText().equals("")) {
            ...
            //            }
                ...
                try {
                    ...
                    ServiceReservationRandonne.getInstance().AddReservation(r);
                    iDialog.dispose();
                    refreshTheme();
