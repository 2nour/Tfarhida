...
public class Reservation {
    ...
    public Reservation(int numreservation, String datereservation, String observation, double montant, Randonnee randonnee, int nombrepersonne, String etat) {
    ...
    public Reservation(int id, int numreservation, String datereservation, String observation, double montant, Randonnee randonnee, int nombrepersonne, String etat) {
        this.id = id;
        this.numreservation = numreservation;
        this.datereservation = datereservation;
        this.observation = observation;
