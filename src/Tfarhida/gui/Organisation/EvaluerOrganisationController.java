...
public class EvaluerOrganisationController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            ...
            //les images 
            etoile1.setImage(new Image("/Tfarhida/images/empty.png"));
            etoile2.setImage(new Image("/Tfarhida/images/empty.png"));
            etoile3.setImage(new Image("/Tfarhida/images/empty.png"));
            etoile4.setImage(new Image("/Tfarhida/images/empty.png"));
            etoile5.setImage(new Image("/Tfarhida/images/empty.png"));
    ...
    private void ligneselectionner(MouseEvent event) throws SQLException {
        ...
        if (noteOrganisation == 1) {
            etoile1.setImage(new Image("/Tfarhida/images/filled.png"));
            etoile2.setImage(new Image("/Tfarhida/images/empty.png"));
            etoile3.setImage(new Image("/Tfarhida/images/empty.png"));
            etoile4.setImage(new Image("/Tfarhida/images/empty.png"));
            etoile5.setImage(new Image("/Tfarhida/images/empty.png"));
        ...
        if (noteOrganisation == 2) {
            etoile1.setImage(new Image("/Tfarhida/images/filled.png"));
            etoile2.setImage(new Image("/Tfarhida/images/filled.png"));
            etoile3.setImage(new Image("/Tfarhida/images/empty.png"));
            etoile4.setImage(new Image("/Tfarhida/images/empty.png"));
            etoile5.setImage(new Image("/Tfarhida/images/empty.png"));
        }
        if (noteOrganisation == 3) {
            etoile1.setImage(new Image("/Tfarhida/images/filled.png"));
            etoile2.setImage(new Image("/Tfarhida/images/filled.png"));
            etoile3.setImage(new Image("/Tfarhida/images/filled.png"));
            etoile4.setImage(new Image("/Tfarhida/images/empty.png"));
            etoile5.setImage(new Image("/Tfarhida/images/empty.png"));
        }
        if (noteOrganisation == 4) {
            ...
            etoile2.setImage(new Image("/Tfarhida/images/filled.png"));
            etoile3.setImage(new Image("/Tfarhida/images/filled.png"));
            etoile4.setImage(new Image("/Tfarhida/images/filled.png"));
            etoile5.setImage(new Image("/Tfarhida/images/empty.png"));
        }
        if (noteOrganisation == 5) {
            ...
            etoile3.setImage(new Image("/Tfarhida/images/filled.png"));
            etoile4.setImage(new Image("/Tfarhida/images/filled.png"));
            etoile5.setImage(new Image("/Tfarhida/images/filled.png"));
        }
