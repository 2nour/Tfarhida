 ...
 * @author Nour
 */
public class TestTemplateProduitController implements Initializable {
   ...
   ArrayList<Produit>  produits = (ArrayList<Produit>) ps.AfficherProduits();
    ...
    public void produitClicked(Produit p){
        ...
        loader.setLocation(getClass().getResource("/Tfarhida/gui/produit/VoirProduit.fxml"));
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        if (produits.size()>0){
           ...
           for(int i=0; i<produits.size();i++)  {
            try {
                FXMLLoader loader = new FXMLLoader();
                loader.setLocation(getClass().getResource("/Tfarhida/gui/produit/CardProduit.fxml"));
                Parent parent = loader.load();
                

                CardProduitController cardController;
                ...
                Logger.getLogger(TestTemplateProduitController.class.getName()).log(Level.SEVERE, null, ex);
            } 
    ...
    private void voirPanier(ActionEvent event) {
        ...
        try{
        Parent parent = FXMLLoader.load(getClass().getResource("/Tfarhida/gui/produit/AfficherPanier.fxml"));
        Scene scene = new Scene(parent);
        Stage stage = new Stage();
        stage.setScene(scene);
