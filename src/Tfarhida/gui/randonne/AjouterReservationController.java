...
return new PasswordAuthentication(username, password);
 ...
 Message message = new MimeMessage(session);
    try {
        ...
        message.setSubject("Nouvelle Reservation");
        message.setText("Bonjour, et bienvenue sur notre site ! Nous te remercions de ton réservation , Votre reservation est bien enregistrer sous le num "+num);
