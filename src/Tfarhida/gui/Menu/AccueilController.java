...
public class AccueilController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
                ...
                n.addEventHandler(MouseEvent.MOUSE_CLICKED, e->{
                    ...
                    try {
                      switch(n.getAccessibleText()){ 
                        ...
                        case "produit": 
                            Node produit = FXMLLoader.load(getClass().getResource("/Tfarhida/gui/AfficherChambre.fxml"));
        ...
        hbct.setRate(-1);
        icon.addEventFilter(MouseEvent.MOUSE_CLICKED, new EventHandler<MouseEvent>() {
            @Override
