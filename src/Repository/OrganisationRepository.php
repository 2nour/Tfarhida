...
class OrganisationRepository extends ServiceEntityRepository
{
    ...
    */
    public function AccepterProgramme()
    {


        $conn = $this->getEntityManager()->getConnection();
        $id=$_GET['idAffected'];
        $sqlu = "UPDATE Organisation SET etat='Accepter' WHERE `id`= $id ";
    ...
    public function RefuserProgramme()
    {


        $conn = $this->getEntityManager()->getConnection();
        $id=$_GET['idRefuser'];
        $sqlu = "UPDATE Organisation SET etat='Refuser' WHERE `id`= $id ";
