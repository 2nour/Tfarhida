    ...
    */
    ...
    public function findRandonnee($var){
        return $this->createQueryBuilder('Reservation')
            ->where('Reservation.numreservation LIKE :varS')
            ->orWhere('Reservation.datereservation LIKE :varS')
            ->orWhere('Reservation.montant LIKE :varS')
            ->orWhere('Reservation.nombrepersonne LIKE :varS')
