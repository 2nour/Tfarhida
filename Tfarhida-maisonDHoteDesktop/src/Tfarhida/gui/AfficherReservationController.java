  ...
  //  private TableColumn<Reservation, String> NomCh;
    ...
    private void loadDate() {
        try {
            ...
            dateReservCh.setCellValueFactory(new PropertyValueFactory<>("date"));
    ...
    private void RefreshTabReservation() {
        try {
            ...
            ste = cnx.prepareStatement(sql);
             rs = ste.executeQuery();
            while(rs.next()){
                data.add(new Reservation(rs.getInt("id"),rs.getInt("chambre_id"), rs.getInt("user_id"), rs.getDate("date_reservation"), rs.getString("etats"), rs.getInt("nbrJour"), rs.getDouble("totalPrix")));
            }
