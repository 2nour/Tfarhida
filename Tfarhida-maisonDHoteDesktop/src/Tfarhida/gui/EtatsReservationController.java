...
public class EtatsReservationController implements Initializable {
    ...
    @FXML
    private TableColumn<Reservation, Integer> nbrJourReserv;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle rb) {
            ...
            dateReser.setCellValueFactory(new PropertyValueFactory<>("date"));   
        ...
        return cell;
            ...
            nbrJourReserv.setCellValueFactory(new PropertyValueFactory<>("nbrJour"));
    ...
    private void RefreshTabReservation() {
        try {
            data.clear();
            sql = "select r.*, u.nom, ch.nom from reservation_maison r "
            ...
            while(rs.next()){
                data.add(new Reservation(
                        ...
                        rs.getInt("user_id"), 
                        new Date(rs.getDate("date_reservation").getTime()), 
                        rs.getString("etats"), 
                        rs.getInt("nbrJour"), 
    ...
    private void AccepterReservation(ActionEvent event) throws SQLException, ProtocolException, IOException {
        ...
        sql = "UPDATE reservation_maison SET id= '"+value1+"',chambre_id= '"+value2+"',user_id= '"+value3+"',etats= '"+value4+"',nbrJour= '"+value5+"',totalPrix= '"+value6+"' WHERE id='"+reservation.getId()+"' ";
        ste= cnx.prepareStatement(sql);
        ste.executeUpdate();
        //ste.close();
    ...
    private void RefuserReservation(ActionEvent event) throws SQLException {
        ...
        SMS sms = new SMS();
        sms.SendSMS("nourhene", "amen123.", "Hello WORLD!", "+21654107042", "https://api.bulksms.com/v1");
